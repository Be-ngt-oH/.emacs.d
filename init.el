...
(custom-set-variables
 ...
 '(package-selected-packages
   '(flycheck-posframe add-node-modules-path ivy-prescient orderless corfu eglot typescript-mode pyvenv git-commit flycheck projectile ivy expand-region markdown-mode multiple-cursors buffer-move editorconfig exec-path-from-shell inf-ruby ripgrep tree-sitter tree-sitter-langs)))
(custom-set-faces
