...
(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path flycheck-popup-tip ivy-prescient orderless corfu eglot typescript-mode pyvenv git-commit flycheck projectile ivy expand-region markdown-mode multiple-cursors buffer-move editorconfig exec-path-from-shell inf-ruby ripgrep)))
(custom-set-faces
